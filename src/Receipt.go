...
func (receipt Receipt) calcPoints() int {
	...
	log.Println("Points after retailer name", points)
	...
	log.Println("Points after round dollar amount", points)
	// 25 points if the total is a multiple of 0.25.
	if cents%25 == 0 {
		points += 25
	}
	log.Println("Points after multiple of 0.25", points)
	// 5 points for every two items on the receipt.
	points += (5 * (len(receipt.Items) / 2))
	log.Println("Points after every two items", points)
	...
	log.Println("Points after item desc", points)
	...
	log.Println("Points after odd purchase date", points)
	...
	log.Println("Points after time of purchase", points)
	return points
}
